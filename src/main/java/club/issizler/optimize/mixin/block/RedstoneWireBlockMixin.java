...
package club.issizler.optimize.mixin.block;

import club.issizler.optimize.Optimize;
import club.issizler.optimize.utils.FastRedstoneWire;
import club.issizler.optimize.utils.accessors.RedstoneWireFastable;
...
public abstract class RedstoneWireBlockMixin implements RedstoneWireFastable {
    ...
    public BlockState calculateCurrentChanges(World worldIn, BlockPos pos1, BlockPos pos2, BlockState state) {
        ...
        if (!Optimize.USE_FAST_REDSTONE || k < 15) {
